...
# *** To back to the orginal version, uncomment this function***
...
#     def on_train_batch_end(state, dataloader_idx):
#         print(f"Finished training batch {state.batch} on dataloader {dataloader_idx}")
...
#     trainer.callbacks.append(on_train_batch_end)
#     trainer.train(dataloaders, dataloader_idx=0)
